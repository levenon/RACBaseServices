...
#define RAC_LOG(log)           _NIFLog(@"=========== INFO ===========", log,DDLogWhitColor, DDLogGrayColor,nil)
#define RAC_INFO(fmt, ...)     _NIFLog(@"=========== INFO ===========", fmt,DDLogWhitColor, DDLogGrayColor, ##__VA_ARGS__)
#define RAC_WARN(fmt, ...)     _NIFLog(@"!!========= WARN =========!!", fmt, DDLogWhitColor, DDLogBlueColor, ##__VA_ARGS__)
#define RAC_ERROR(fmt, ...)    _NIFLog(@"!!!======== ERROR =========!!!", fmt, DDLogWhitColor, DDLogRedColor, ##__VA_ARGS__)
#define RAC_DEBUG(fmt, ...)    _NIFLog(@"!========== DEBUG ==========!", fmt, DDLogWhitColor, DDLogBrownColor, ##__VA_ARGS__)
#define RAC_SUCCESS(fmt, ...)  _NIFLog(@"!========== SUCCESS ==========!", fmt, DDLogWhitColor, DDLogGreenColor, ##__VA_ARGS__)

#define RAC_CONDITION(condition, operator)  if(condition){ operator; }
